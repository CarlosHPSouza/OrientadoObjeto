...
namespace Contato {
    ...
    public partial class ContactDBDataSet1 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(string Nome, string Company, string Telephone, string Email, bool Client, System.DateTime LastCall) {
            ...
            public string Nome {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Nome\' in table \'Table\' is DBNull.", e);
                    }
                }
                set {
...
namespace Contato.ContactDBDataSet1TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([ContactID] = @Original_ContactID) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_Company = 1 AND [Company] IS NULL) OR ([Company] = @Original_Company)) AND ((@IsNull_Telephone = 1 AND [Telephone] IS NULL) OR ([Telephone] = @Original_Telephone)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Client = 1 AND [Client] IS NULL) OR ([Client] = @Original_Client)) AND ((@IsNull_LastCall = 1 AND [LastCall] IS NULL) OR ([LastCall] = @Original_LastCall)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Table] ([Nome], [Company], [Telephone], [Email], [Client], [LastCall]) VALUES (@Nome, @Company, @Telephone, @Email, @Client, @LastCall);
SELECT ContactID, Nome, Company, Telephone, Email, Client, LastCall FROM [Table] WHERE (ContactID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Nome] = @Nome, [Company] = @Company, [Telephone] = @Telephone, [Email] = @Email, [Client] = @Client, [LastCall] = @LastCall WHERE (([ContactID] = @Original_ContactID) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_Company = 1 AND [Company] IS NULL) OR ([Company] = @Original_Company)) AND ((@IsNull_Telephone = 1 AND [Telephone] IS NULL) OR ([Telephone] = @Original_Telephone)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Client = 1 AND [Client] IS NULL) OR ([Client] = @Original_Client)) AND ((@IsNull_LastCall = 1 AND [LastCall] IS NULL) OR ([LastCall] = @Original_LastCall)));
SELECT ContactID, Nome, Company, Telephone, Email, Client, LastCall FROM [Table] WHERE (ContactID = @ContactID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Contato.Properties.Settings.Default.ContactDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ContactID, Nome, Company, Telephone, Email, Client, LastCall FROM dbo.[Tab" +
                "le]";
        ...
        public virtual int Fill(ContactDBDataSet1.TableDataTable dataTable) {
        ...
        public virtual ContactDBDataSet1.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ContactDBDataSet1.TableDataTable dataTable = new ContactDBDataSet1.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ContactDBDataSet1.TableDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ContactID, string Original_Nome, string Original_Company, string Original_Telephone, string Original_Email, global::System.Nullable<bool> Original_Client, global::System.Nullable<global::System.DateTime> Original_LastCall) {
        ...
        public virtual int Insert(string Nome, string Company, string Telephone, string Email, global::System.Nullable<bool> Client, global::System.Nullable<global::System.DateTime> LastCall) {
            if ((Nome == null)) {
        ...
        public virtual int Update(string Nome, string Company, string Telephone, string Email, global::System.Nullable<bool> Client, global::System.Nullable<global::System.DateTime> LastCall, int Original_ContactID, string Original_Nome, string Original_Company, string Original_Telephone, string Original_Email, global::System.Nullable<bool> Original_Client, global::System.Nullable<global::System.DateTime> Original_LastCall, int ContactID) {
            if ((Nome == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nome, string Company, string Telephone, string Email, global::System.Nullable<bool> Client, global::System.Nullable<global::System.DateTime> LastCall, int Original_ContactID, string Original_Nome, string Original_Company, string Original_Telephone, string Original_Email, global::System.Nullable<bool> Original_Client, global::System.Nullable<global::System.DateTime> Original_LastCall) {
            return this.Update(Nome, Company, Telephone, Email, Client, LastCall, Original_ContactID, Original_Nome, Original_Company, Original_Telephone, Original_Email, Original_Client, Original_LastCall, Original_ContactID);
        }
    }
